 ...
 */
public class NextTimeALineWithObjectProperty implements LineWithObjectProperty {
	...
	public NextTimeALineWithObjectProperty(
	...
	public static void main(String args[]) {
			LineWithObjectProperty line =  new NextTimeALineWithObjectProperty(
