...
public class NextTimeACartesianPlane implements CartesianPlane {	
 ...
 */
    ...
    public NextTimeACartesianPlane (int theAxesLength, int theOriginX, int theOriginY ) {    	
 ...
 */
    ...
    public static void main (String[] args) {
    	CartesianPlane aCartesianPlane = 
    		new NextTimeACartesianPlane(INIT_AXES_LENGTH, INIT_ORIGIN_X, INIT_ORIGIN_Y);
