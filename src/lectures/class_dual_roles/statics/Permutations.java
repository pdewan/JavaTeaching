 ...
 * variables can be defined independently of another set of methods and 
 * variables, then the two sets should be in different classes.
 * 
 * Based on this principle, should this class and 
 * {@link Factorials} be combined into one class or different classes?
 *
 */
