...
public class ABMISpreadsheet  {
	...
	double height;	
	/*
	 * The following is an initialization declaration.
	 */
//	double height = 2.0; 
	double weight;	
	/*
	 ...
	 * which can initialize the variables (or not).
	 * Initialization means it gives the variables its initial values - non-final
	 * variables can be changed multiple times.
	 * 
	 * What follows new is not the name of the class but the name of the constructor and 
	 * its parameters.
	 ...
	 * In contrast a method must have a return type.
	 *
	 ...
	 * (T/F) During the life time of an object, multiple constructors can be called to 
	 * operate on it.
	 * (T/F) A constructor "constructs" the object, that is, allocates space for the instance
	 *  variables of the object in memory.
	 */
