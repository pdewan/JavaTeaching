 ...
 *
 */
public class NextTimeAnObservableLine extends ANonObservableLine implements ObservableLine  {
	
	PropertyListenerSupport propertySupport = new APropertyListenerSupport();
	
	public NextTimeAnObservableLine (int initX, int initY, int initWidth, int initHeight) {
...
*/
	...
	public static void main(String args[]) {
		Line aLine = new NextTimeAnObservableLine(10, 10, 30, 30);
