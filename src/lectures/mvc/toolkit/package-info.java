 ...
 * 
 * We only however, wrote the observable part of the pattern. 
 * 
 ...
 * 
 * We will also see this pattern can be a part of a bigger pattern, called
 * MVC (foe model view controller), that decomposes the
