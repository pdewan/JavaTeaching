...
public class AnInheritingStringDatabaseNextTime 
...
//	protected int size = 0;
	...
	public AnInheritingStringDatabaseNextTime() {
		super();
//		super(2);
		uselessVariable = 2;
 ...
 */
    ...
    public static void main (String[] args) {
    	InheritingStringDatabase stringDatabase = new AnInheritingStringDatabaseNextTime();
